...
export default function Projects() {
  ...
  return (
          ...
          {slides.map((slide) => (
            <div key={slide.id} className="w-full shrink-0">
              <div className="grid gap-6 lg:grid-cols-[1fr_0.96fr] lg:gap-8">
                <div className="overflow-hidden rounded-[18px] bg-[#efe6da] text-left shadow-sm">
                  <img
                    src={projectLarge}
                    alt="project"
                    className="h-[260px] w-full object-cover sm:h-[340px] md:h-[420px] lg:h-[620px] xl:h-[720px]"
                  />
                  <div className="bg-[#FFF6EB] px-5 py-5 sm:px-6">
                   ...
                   <Link href="/projects"> <button className="mt-6 rounded-full border border-[#765640] px-6 py-2.5 text-sm font-medium hover:bg-white/60 sm:px-7 sm:py-3">
                      Read More →
                    </button></Link>
                  </div>
                </div>
                  ...
                  {slide.smallProjects.map((item) => (
                    ...
                    >
                      <img
                        src={projectSmall}
                        alt="project"
                        className="h-[220px] w-full object-cover sm:h-[260px] md:h-[300px] lg:h-[280px] xl:h-[320px]"
                      />
                      <div className="flex flex-col gap-4 bg-[#FFF6EB] px-5 py-5 sm:px-6 md:flex-row md:items-center md:justify-between">
                        <div>
                          ...
                          <p className="mt-2 max-w-full text-[12px] leading-5 text-[#6b655f] md:max-w-[350px]" style={{
    display: '-webkit-box',
    WebkitLineClamp: 2,
    ...
    overflow: 'hidden',
                      ...
                      <Link href="/projects">  <button className="rounded-full border border-[#765640] px-6 py-2.5 text-sm font-medium hover:bg-white/60 sm:px-7 sm:py-3">
                          Read More →
                        </button> </Link> 
                      </div>
                    </div>
